        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    <span>Employer List</span>企业信息</h3>
					<!---728x90--->
                <div class="row choose-main mt-5">
                    ...
                    <div class="col-lg-8 job_info_left" id="cpList">
                        <!--/ Emply List -->
			...
			layui.use(["layer","form"],function(){
				...
				$("#cpList").on("click","a",function(){
					...
					layer.open({
						...
						btnAlign:'c',
						maxmin:true,
						content: 'cp_single.html?cpN='+cpData[num].cpId,
						success: function(layero, index){
							var body = layer.getChildFrame('body', index);
							body.find("#logo").attr("src","../upload/"+cpData[num].cpName+".jpg");
							body.find("#cpName").text(cpData[num].cpName);
							body.find("#tel").text(cpData[num].tel);
							body.find("#idtName").text(cpData[num].indus.idtName);
							body.find("#dis").text(cpData[num].dis);
							body.find("#email").text(cpData[num].email);
							if(cpData[num].che=="1"){
								body.find("#che").text("已验证");
							}else{
								body.find("#che").text("未验证");
							}
						}
					});
				});
